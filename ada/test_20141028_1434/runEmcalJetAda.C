...
TString     kPluginAliRootVersion    = "vAN-20141022";
...
void runEmcalJetAda (const char* analysis_mode = "local", const char* plugin_mode = "test", const char* input = "data.txt")
    {
...
//______________________________________________________________________________
    ...
    TString        acceptance_type     = "EMCAL";         // TPC or EMCAL
    UInt_t         kAcceptance_type    = 99;
    ...
    if (acceptance_type.EqualTo("TPC"))   { kAcceptance_type = kTPC; }
    else
    if (acceptance_type.EqualTo("EMCAL")) { kAcceptance_type = kEMCAL; }
    else
        { kAcceptance_type = kUser; }
...
// ################# Now: Add jet finders+analyzers
    ...
    if (doBkg)
        ...
        cout << "starting AddTaskRho.C" << endl;
        ...
        AliAnalysisTaskRho* rhotask = AddTaskRho (kTpcKtJetsName.Data(), tracksName.Data(), clustersCorrName.Data(), rhoName.Data(), radius, "EMCAL", jetareacut, emcareacut, sfunc, exclJets, kTRUE);
    ...
    AliAnalysisTaskLocalRho* lRho = AddTaskLocalRho ( tracksName.Data(), clustersCorrName.Data(), jetFinderTask_015_04->GetJetsName(), nrho, lrho,
                                                      jetradius, jetptcut, jetareacut, kAcceptance_type, leadhadtype,
    ...
    AliAnalysisTaskEmcalJetSpectra* spectraTask = AddTaskEmcalJetSpectra ( outfilename,  jetFinderTask_015_04->GetJetsName(),  kAcceptance_type,
                                                                           nrho, lrho, minPhi, maxPhi, minEta, maxEta, minArea, tracksName.Data());
