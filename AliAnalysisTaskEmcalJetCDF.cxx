...
Bool_t AliAnalysisTaskEmcalJetCDF::Run()
    ...
    fNJets_accepted = fJetsCont->GetNJets() ;  // Number of Jets found in event - accepted cuts applied by JetContainer
    fNaccPart       = fTracksCont->GetNAcceptedParticles(); // Multiplicity in event - accepted tracks in tracks container
...
// Leading Jet
    ...
    if ( fDebug > 1 ) { std::cout << "+++++++++++++++++>>>>>>>>> Leading jet found"  << std::endl; fJet1->Print(); }
...
// computing of pt sum of event - acccepted tracks
    ...
    track = NULL;
    if ( fDebug > 2 ) { std::cout << "Sum of Pt in event pt_sum_event = " << fEvPt << std::endl; }
...
// parsing tracks of jet1 (leading jet) in decreasing order of Pt
    ...
    for ( Size_t i = 0 ; i < jet1_npart ; i++ )
        ...
        jet1_idx_list.AddAt( track_idx, i); // fill the jet1 track index list with the indexes of tracks
...
for ( Size_t i = 0 ; i < fNaccPart ; i++ )
        ...
        Double_t dphi_part_jet1 = TVector2::Phi_mpi_pi ( track->Phi() - fJet1->Phi() ); // restrict the delta phi to (-pi,pi) interval
...
// dphi track to jet1 distribution (total and per toward,away,transverse regions)
        ...
        if ( !IdxInArray (track_idx, jet1_idx_list) )
            { // fill histos without tracks from leading jet
            ...
            if ( ( dphi_part_jet1 <= (-1)*kPI_3 ) && ( dphi_part_jet1 > (-1)*k2PI_3 ) )
                ...
                fH22Transverse_min_bin_wojet1->Fill ( jet1_pt, track_pt );     // PT_{sum}(in the event - including jet1) vs P_{T}(jet1)
                }
            else
            if ( ( dphi_part_jet1 >= kPI_3 ) && ( dphi_part_jet1 < k2PI_3 ) )
                {
                fH21Transverse_max_bin_wojet1->Fill ( jet1_pt );               // N (in the event - including jet1) vs P_{T}(jet1)
                fH22Transverse_max_bin_wojet1->Fill ( jet1_pt, track_pt );     // PT_{sum}(in the event - including jet1) vs P_{T}(jet1)
                }
            else
            if ( ( dphi_part_jet1 >= k2PI_3 ) || ( dphi_part_jet1 <= (-1)*k2PI_3 ) )
                {
...
void AliAnalysisTaskEmcalJetCDF::UserCreateOutputObjects()
    ...
    fH9_bin_wojet1 = new TH1D ( "histo9_bin_wojet1", "N vs the Azimuthal Angle from Jet1 - wo jet1 components", h9_nbin , h9_xlow , h9_xhigh );
    ...
    //____________________________________________________________________________________
    Int_t h10_nbin = 50; Double_t h10_binwidth = 3.6; Double_t h10_xlow = 0. ; Double_t h10_xhigh = h10_xlow + h10_binwidth * h10_nbin;
    ...
    fH10_bin_wojet1 = new TH1D ( "histo10_bin_wojet1", "P_{T} sum vs the Azimuthal Angle from Jet1 - wo jet1 components", h10_nbin , h10_xlow , h10_xhigh );
    ...
    //____________________________________________________________________________________
    Int_t h15_nbin = 100; Double_t h15_binwidth = 0.01; Double_t h15_xlow = 0. ; Double_t h15_xhigh = h15_xlow + h15_binwidth * h15_nbin;
    ...
    fH15_n80 = new TProfile ( "histo15_n80", "<p_{T}> track vs the Distance R from Jet1 - 80% of particles", h15_nbin , h15_xlow , h15_xhigh );
    ...
    fH15_pt80 = new TProfile ( "histo15_pt80", "<p_{T}> track vs the Distance R from Jet1 - 80% of Pt", h15_nbin , h15_xlow , h15_xhigh );
    ...
    fH15_bin_n80 = new TProfile ( "histo15_bin_n80", "p_{T}*dR (track) vs the Distance R from Jet1 - 80% of particles", h15_nbin , h15_xlow , h15_xhigh );
    ...
    fH15_bin_pt80 = new TProfile ( "histo15_bin_pt80", "pp_{T}*dR (track) vs the Distance R from Jet1 - 80% of Pt", h15_nbin , h15_xlow , h15_xhigh );
    ...
    //____________________________________________________________________________________
    Int_t h20_nbin = 100; Double_t h20_binwidth = 0.01; Double_t h20_low = 0.; Double_t h20_high = h20_low + h20_binwidth * h20_nbin;
    ...
    fH20_n80 = new TH1D ( "histo20_n80", "Distribution of R in leading jet - 80% of particles", h20_nbin, h20_low, h20_high );
    ...
    fH21Toward_bin = new TH1D ( "histo21_toward_bin", "N(in the event - including jet1) vs P_{T}(jet1) - toward", 200, 0., 200. ) ;
    ...
    fH21Transverse_min_bin = new TH1D ( "histo21_transverse_min_bin", "N(in the event - including jet1) vs P_{T}(jet1) - transverse MIN", 200, 0., 200. ) ;
    ...
    fH21Transverse_max_bin = new TH1D ( "histo21_transverse_max_bin", "N(in the event - including jet1) vs P_{T}(jet1) - transverse MAX", 200, 0., 200. ) ;
    ...
    fH21Toward_bin_wojet1 = new TH1D ( "histo21_toward_bin_wojet1", "N(in the event - without jet1) vs P_{T}(jet1) - toward", 200, 0., 200. ) ;
    ...
    fH21Transverse_min_bin_wojet1 = new TH1D ( "histo21_transverse_min_bin_wojet1", "N(in the event - without jet1) vs P_{T}(jet1) - transverse MIN", 200, 0., 200. ) ;
    ...
    fH21Transverse_max_bin_wojet1 = new TH1D ( "histo21_transverse_max_bin_wojet1", "N(in the event - without jet1) vs P_{T}(jet1) - transverse MAX", 200, 0., 200. ) ;
    ...
    fH21Away_bin_wojet1 = new TH1D ( "histo21_away_bin_wojet1", "N(in the event - without jet1) vs P_{T}(jet1) - away", 200, 0., 200. ) ;
    ...
    fH22Toward_bin = new TH1D ( "histo22_toward_bin", "PT_{sum}(in the event - including jet1) vs P_{T}(jet1) - toward", 200, 0. , 200. ) ;
    ...
    fH22Transverse_min_bin = new TH1D ( "histo22_transverse_min_bin", "PT_{sum}(in the event - including jet1) vs P_{T}(jet1) - transverse MIN", 200, 0. , 200. ) ;
    ...
    fH22Transverse_max_bin = new TH1D ( "histo22_transverse_max_bin", "PT_{sum}(in the event - including jet1) vs P_{T}(jet1) - transverse MAX", 200, 0. , 200. ) ;
    ...
    fH22Away_bin = new TH1D ( "histo22_away_bin", "PT_{sum}(in the event - including jet1) vs P_{T}(jet1) - away", 200, 0. , 200. ) ;
    ...
    //__________________________________________________________________
    fH22_bin_wojet1 = new TH1D ( "histo22_bin_wojet1", "PT_{sum}(in the event - without jet1) vs P_{T}(jet1)", 200, 0. , 200. ) ;
    ...
    fH22Toward_bin_wojet1 = new TH1D ( "histo22_toward_bin_wojet1", "PT_{sum}(in the event - without jet1) vs P_{T}(jet1) - toward", 200, 0. , 200. ) ;
    ...
    fH22Transverse_min_bin_wojet1 = new TH1D ( "histo22_transverse_min_bin_wojet1", "PT_{sum}(in the event - without jet1) vs P_{T}(jet1) - transverse MIN", 200, 0. , 200. ) ;
    ...
    fH22Transverse_max_bin_wojet1 = new TH1D ( "histo22_transverse_max_bin_wojet1", "PT_{sum}(in the event - without jet1) vs P_{T}(jet1) - transverse MAX", 200, 0. , 200. ) ;
    ...
    fH22Away_bin_wojet1 = new TH1D ( "histo22_away_bin_wojet1", "PT_{sum}(in the event - without jet1) vs P_{T}(jet1) - away", 200, 0. , 200. ) ;
    ...
    fH26_n80 = new TProfile ( "histo26_n80", "<N> vs the Distance R from Jet1 - 80% of particles", h26_nbin, h26_low, h26_high );
    ...
    fH26jet1_n80 = new TProfile ( "histo26jet1_n80", "<N>(jet1) vs the Distance R from Jet1 - 80% of particles", h26_nbin, h26_low, h26_high );
    ...
    fH26jet1_pt80 = new TProfile ( "histo26jet1_pt80", "<N>(jet1) vs the Distance R from Jet1 - 80% of Pt", h26_nbin, h26_low, h26_high );
    ...
    fH26_n80_bin = new TH1D ( "histo26_n80_bin", "<N> vs the Distance R from Jet1 - 80% of particles", h26_nbin, h26_low, h26_high );
    ...
    fH26_pt80_bin = new TH1D ( "histo26_pt80_bin", "<N> vs the Distance R from Jet1 - 80% of Pt", h26_nbin, h26_low, h26_high );
    ...
    fH26jet1_n80_bin = new TH1D ( "histo26jet1_n80_bin", "<N>(jet1) vs the Distance R from Jet1 - 80% of particles", h26_nbin, h26_low, h26_high );
    ...
    fH26jet1_pt80_bin = new TH1D ( "histo26jet1_pt80_bin", "<N>(jet1) vs the Distance R from Jet1 - 80% of Pt", h26_nbin, h26_low, h26_high );
    ...
    fH27_n80 = new TProfile ( "histo27_n80", "PT_{sum} vs the Distance R from Jet1 - 80% of particles", h27_nbin, h27_low, h27_high );
    ...
    fH27_pt80 = new TProfile ( "histo27_pt80", "PT_{sum} vs the Distance R from Jet1 - 80% of Pt", h27_nbin, h27_low, h27_high );
    ...
    fH27_n80_bin = new TH1D ( "histo27_n80_bin", "PT_{sum} vs the Distance R from Jet1 - 80% of particles", h27_nbin, h27_low, h27_high );
    ...
    fH27_pt80_bin = new TH1D ( "histo27_pt80_bin", "PT_{sum} vs the Distance R from Jet1 - 80% of Pt", h27_nbin, h27_low, h27_high );
    ...
    fH27jet1_n80_bin = new TH1D ( "histo27jet1_n80_bin", "Jet1 p_{T} vs the Distance R from Jet1 - 80% of particles", h27_nbin, h27_low, h27_high );
    ...
    fH27jet1_pt80_bin = new TH1D ( "histo27jet1_pt80_bin", "Jet1 p_{T} vs the Distance R from Jet1 - 80% of Pt", h27_nbin, h27_low, h27_high );
    ...
    //____________________________________________________________________________________
    fH40_bin = new TH1D ( "histo40_bin", "total particles fNPart w.r.t PTmax (pt of leading particle from jet1)", h40_nbin, h40_low, h40_high );
    ...
    fH40toward_bin = new TH1D ( "histo40toward_bin", "total particles fNPart w.r.t PTmax (pt of leading particle from jet1) - TOWARD", h40_nbin, h40_low, h40_high );
    ...
    fH40away_bin = new TH1D ( "histo40away_bin", "total particles fNPart w.r.t PTmax (pt of leading particle from jet1) - AWAY", h40_nbin, h40_low, h40_high );
    ...
    fH40transmin_bin = new TH1D ( "histo40transmin_bin", "total particles fNPart w.r.t PTmax (pt of leading particle from jet1) - TRANSMIN", h40_nbin, h40_low, h40_high );
    ...
    fH40transmax_bin = new TH1D ( "histo40transmax_bin", "total particles fNPart w.r.t PTmax (pt of leading particle from jet1) - TRANSMAX", h40_nbin, h40_low, h40_high );
    ...
    //____________________________________________________________________________________
    fH41_bin = new TH1D ( "histo41_bin", "PTsum w.r.t PTmax (pt of leading particle from jet1)", h41_nbin, h41_low, h41_high );
    ...
    fH41toward_bin = new TH1D ( "histo41toward_bin", "PTsum w.r.t PTmax (pt of leading particle from jet1) - TOWARD", h41_nbin, h41_low, h41_high );
    ...
    fH41away_bin = new TH1D ( "histo41away_bin", "PTsum w.r.t PTmax (pt of leading particle from jet1) - AWAY", h41_nbin, h41_low, h41_high );
    ...
    fH41transmin_bin = new TH1D ( "histo41transmin_bin", "PTsum w.r.t PTmax (pt of leading particle from jet1) - TRANSMIN", h41_nbin, h41_low, h41_high );
    ...
    fH41transmax_bin = new TH1D ( "histo41transmax_bin", "PTsum w.r.t PTmax (pt of leading particle from jet1) - TRANSMAX", h41_nbin, h41_low, h41_high );
