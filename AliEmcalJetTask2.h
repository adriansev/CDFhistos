...
class AliEmcalJetTask2 : public AliAnalysisTaskSE
    {
    public:
        ...
        AliEmcalJetTask2();
        AliEmcalJetTask2 ( const char* name );
        virtual ~AliEmcalJetTask2();
        ...
        void                   SetParticleContainer ( AliParticleContainer* cont ) { fTracksCont   = cont; }
        void                   SetClusterContainer  ( AliClusterContainer*  cont ) { fClustersCont = cont; }
        ...
        AliParticleContainer*  GetParticleContainer()           { return fTracksCont; }
        AliClusterContainer*   GetClusterContainer()            { return fClustersCont; }

    protected:
        void                   FindJets();
        Bool_t                 DoInit();
        Bool_t                 GetTracksContainer();
        Bool_t                 GetClustersContainer();
        Bool_t                 GetTracksEvent();
        Bool_t                 GetClustersEvent();
        ...
        AliClusterContainer*   fClustersCont;           //! Clusters container
    ...
    private:
        ...
        struct sort_descend
            ...
            bool operator () ( const fastjet::PseudoJet& jet1, const fastjet::PseudoJet& jet2 ) { return jet1.perp() > jet2.perp(); }
            };

        AliEmcalJetTask2 ( const AliEmcalJetTask2& );         // not implemented
        AliEmcalJetTask2& operator= ( const AliEmcalJetTask2& ); // not implemented

        ClassDef ( AliEmcalJetTask2, 16 ) // Jet producing task
    };
#endif
