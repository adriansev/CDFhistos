...
//______________________________________________________________________________
    ...
    TString clustersName       = "CaloClusters";      // runEmcalJetAnalysis default = EmcCaloClusters
...
//#####################################################################################
    ...
    jetminpt = 1.;
    anaTask    = AddTaskEmcalJetCDF (jetFinderTask_015_02, jetminpt, jetareacut, acceptance_type.Data(), leadhadtype, "CDF1_02");
    anaTask->SetDebugLevel(debug);

//     jetminpt = 1.;
//     anaTask    = AddTaskEmcalJetCDF (jetFinderTask_015_03, jetminpt, jetareacut, acceptance_type.Data(), leadhadtype, "CDF1_03");
//     anaTask->SetDebugLevel(debug);

//     jetminpt = 1.;
//     anaTask    = AddTaskEmcalJetCDF (jetFinderTask_015_04, jetminpt, jetareacut, acceptance_type.Data(), leadhadtype, "CDF1_04");
//     anaTask->SetDebugLevel(debug);
//
//     jetminpt = 1.;
//     anaTask    = AddTaskEmcalJetCDF (jetFinderTask_015_06, jetminpt, jetareacut, acceptance_type.Data(), leadhadtype, "CDF1_06");
//     anaTask->SetDebugLevel(debug);
