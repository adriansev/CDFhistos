...
Long64_t    nentries                 = 12; //34567890; // for local and proof mode, ignored in grid mode. Set to 1234567890 for all events.
Long64_t    firstentry               = 0; // for local and proof mode, ignored in grid mode

TString     kTrainName               = "sev_EMCALchg";           // *CHANGE ME* (no blancs or special characters)
TString     kWorkDir                 = "lhc10e_EMCALchg";           // AliEn work dir; relative to AliEn $HOME
TString     kJobTag                  = "sev_EMCALchg";   // *CHANGE ME*
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    const char*    acceptance_type     = "EMCAL" ;          // TPC or EMCAL
...
//#####################################################################################
    ...
    // R = 0.6
    jetminpt = 1.;
    AliAnalysisTaskEmcalJetCDF* anaTask1_2    = AddTaskEmcalJetCDF (jetFinderTask_015_02_chg, jetminpt, jetareacut, acceptance_type, leadhadtype, "CDF7");

    jetminpt = 5.;
    AliAnalysisTaskEmcalJetCDF* anaTask2_2    = AddTaskEmcalJetCDF (jetFinderTask_015_02_chg, jetminpt, jetareacut, acceptance_type, leadhadtype, "CDF8");

    jetminpt = 10.;
    AliAnalysisTaskEmcalJetCDF* anaTask3_2    = AddTaskEmcalJetCDF (jetFinderTask_015_02_chg, jetminpt, jetareacut, acceptance_type, leadhadtype, "CDF9");

    jetminpt = 20.;
    AliAnalysisTaskEmcalJetCDF* anaTask4_2    = AddTaskEmcalJetCDF (jetFinderTask_015_02_chg, jetminpt, jetareacut, acceptance_type, leadhadtype, "CDF10");

    jetminpt = 30.;
    AliAnalysisTaskEmcalJetCDF* anaTask5_2    = AddTaskEmcalJetCDF (jetFinderTask_015_02_chg, jetminpt, jetareacut, acceptance_type, leadhadtype, "CDF11");
